...
const questions = [
    {
      ...
      "options": ["Doctor", "Nurse", "Writer", "Waitress"],
      "rightAnswer": 1
    },
    {
      "question": "My house is near the...",
      "options": ["City", "Monastery", "Mountains", "Italy"],
      "rightAnswer": 2
    },
    {
      "question": "How old was I when my grandmother came?",
      "options": ["Three years old", "Just born", "Ten years old", "Two years old"],
      "rightAnswer": 3
    },
    {
      "question": "On the weekends, we...",
      "options": ["Play board games together", "Go to a movie", "Clean the house", "Cook pasta"],
      "rightAnswer": 0
    },
    {
